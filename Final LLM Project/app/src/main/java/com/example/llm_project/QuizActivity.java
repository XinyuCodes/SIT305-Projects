...
public class QuizActivity extends AppCompatActivity {
    ...
    private int score = 0, checkCurrent;
    ...
    private void checkAnswer(String selected) {
        ...
        executorService.execute(() -> {
            QuizQuestion newQuiz = new QuizQuestion();
            newQuiz.userId = userId;
            newQuiz.topic = topic;
            newQuiz.score = score;
            newQuiz.question = currentQuestionFull;
            newQuiz.answer = selected;
            newQuiz.correctAnswer = correctAnswer;
            newQuiz.date = System.currentTimeMillis();
            db.quizQuestionDao().insert(newQuiz);
        });
    }
